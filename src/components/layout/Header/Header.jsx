...
export default function Header() {
  ...
  return (
    <header
      style={{ height: "60px" }}
      className={`${styles.header} container-fluid d-flex flex-row position-fixed top-0 start-0 px-0 justify-content-center justify-content-lg-between align-items-center`}>
      <section
