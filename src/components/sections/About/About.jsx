  ...
  return (
    <section
      ...
      <section className="gap-2 gap-md-2 gap-lg-3 order-2 order-lg-1 col-11 col-md-8 col-lg-5 d-flex flex-column justify-content-center align-items-center ">
        ...
        <h2 className="apperEffect sharedTitle text-center m-0">
          ¡Hola! Soy Rolando
        </h2>
        <p className={`apperEffect p-2 m-0 ${styles.paragraphAbout}`}>
        ...
        <div className="apperEffectDown pb-2 d-flex container-fluid justify-content-evenly align-items-center">
          <a
